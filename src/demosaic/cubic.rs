...
macro_rules! apply_kernel_c {
    ($T:ident; $row:ident, $w:expr,
        ...
        let g_pos = ($prv1[j] as u32 + $curr[j - 1] as u32 + $curr[j + 1] as u32 + $nxt1[j] as u32)
            * 81
            + ($prv3[j] as u32 + $curr[j - 3] as u32 + $curr[j + 3] as u32 + $nxt3[j] as u32);
        let g_neg = ($prv2[j - 1] as u32
            + $prv2[j + 1] as u32
            + $prv1[j - 2] as u32
            + $prv1[j + 2] as u32
            + $nxt1[j - 2] as u32
        ...
        let d_pos =
            ($prv1[j - 1] as u32 + $prv1[j + 1] as u32 + $nxt1[j - 1] as u32 + $nxt1[j + 1] as u32)
                * 81
                + ($prv3[j - 3] as u32
                    + $prv3[j + 3] as u32
                    + $nxt3[j - 3] as u32
                    + $nxt3[j + 3] as u32);
        let d_neg = ($prv3[j - 1] as u32
            + $prv3[j + 1] as u32
            + $prv1[j - 3] as u32
            + $prv1[j + 3] as u32
            + $nxt1[j - 3] as u32
...
mod tests {
    ...
    fn test_even() {
        ...
        let expected = [
            229, 122, 186, 161, 67, 172, 95, 43, 108, 155, 146, 58, 232, 61, 104, 239, 51, 169,
            229, 117, 196, 228, 241, 206, 182, 169, 174, 177, 110, 161, 177, 15, 98, 201, 70, 52,
            219, 45, 105, 189, 104, 175, 154, 98, 195, 145, 159, 197, 127, 159, 116, 185, 183, 105,
            253, 95, 48, 242, 97, 15, 199, 121, 106, 123, 239, 203, 54, 153, 195, 35, 166, 167,
            135, 32, 76, 140, 103, 68, 151, 98, 21, 176, 121, 3, 179, 97, 114, 105, 159, 222, 27,
            87, 180, 8, 115, 123, 153, 80, 146, 98, 126, 141, 47, 157, 116, 111, 211, 100, 171,
            168, 142, 106, 203, 175, 27, 179, 110, 9, 185, 52, 139, 105, 211, 115, 154, 210, 99,
            165, 209, 153, 167, 200, 193, 141, 175, 124, 179, 135, 42, 202, 57, 23, 160, 5, 122,
            118, 139, 143, 187, 145, 177, 158, 170, 211, 122, 194, 220, 110, 200, 143, 112, 184,
            62, 94, 114, 42, 18, 60, 118, 25, 68, 148, 129, 80, 193, 132, 120, 224, 111, 169, 226,
            104, 213, 148, 95, 233, 66, 75, 171, 46, 16, 117,
        ];
    ...
    fn test_odd() {
        ...
        let expected = [
            229, 147, 204, 161, 67, 183, 95, 123, 96, 155, 146, 12, 232, 52, 14, 238, 51, 38, 229,
            123, 41, 171, 241, 188, 136, 163, 169, 111, 161, 90, 177, 144, 15, 247, 52, 20, 243,
            93, 45, 225, 175, 48, 98, 236, 114, 102, 197, 104, 127, 185, 61, 195, 183, 23, 253, 95,
            42, 230, 97, 71, 199, 99, 76, 85, 239, 56, 88, 208, 54, 105, 166, 38, 160, 129, 32,
            201, 68, 63, 159, 53, 98, 116, 3, 106, 97, 231, 114, 88, 222, 105, 87, 178, 63, 126,
            123, 30, 153, 125, 63, 97, 126, 104, 47, 124, 114, 135, 211, 189, 122, 214, 171, 114,
            203, 94, 149, 165, 27, 174, 185, 57, 124, 138, 105, 79, 210, 114, 165, 203, 205, 150,
            200, 185, 141, 184, 101, 175, 135, 26, 202, 116, 56, 160, 5, 105, 122, 93, 115,
        ];
    ...
    fn test_overflow() {
        ...
        let expected = [
            ...
            255, 0, 111, 255, 0, 0, 255, 0, 111, 255, 190, 255, 255, 255, 255, 255, 255, 255, 255,
            255, 255, 255, 111, 174, 255, 0, 111, 255, 111, 174, 255, 255, 255, 255, 255, 255, 255,
            255, 255, 255, 255, 255, 255, 255, 255, 255, 190, 255, 255, 255, 255, 255, 255, 255,
            255, 255, 255, 255, 255, 251, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255,
            255, 255, 255, 255, 255, 255, 251,
        ];
